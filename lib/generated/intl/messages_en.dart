...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "ACTIVE_STATE" : MessageLookupByLibrary.simpleMessage("Currently active:"),
    "ADMIN_FAILURE_MESSAGE" : MessageLookupByLibrary.simpleMessage("The server-sided app configuration has not yet been completed by your organization. Please contact your administrator."),
    ...
    "AUTHENTICATION_FAILURE_MESSAGE" : MessageLookupByLibrary.simpleMessage("Access rights to the ressources on the server were revoked. Please log in again."),
    "BACK" : MessageLookupByLibrary.simpleMessage("Go back"),
    "CACHE_FAILURE_MESSAGE" : MessageLookupByLibrary.simpleMessage("An error occured while stored ressources were accessed."),
    ...
    "LOCATION_DISCLAIMER" : MessageLookupByLibrary.simpleMessage("In this state the app collects location data to enable mission control to monitor your location during the mission even when the app is closed or not in use."),
    ...
    "MISSIONS_AND_EXERCICES" : MessageLookupByLibrary.simpleMessage("Missions and Exercises"),
    ...
    "ORGANIZATION_TRACKING" : MessageLookupByLibrary.simpleMessage("Your organisation enabled location tracking for the following states:"),
    ...
    "PRIVACY_NOTICE" : MessageLookupByLibrary.simpleMessage("Privacy Notice"),
    ...
    "SELECT_STATE" : MessageLookupByLibrary.simpleMessage("Select new state:"),
    ...
    "TOKEN_EXPIRED_FAILURE_MESSAGE" : MessageLookupByLibrary.simpleMessage("Access rights to the ressources on the server expired. Please log in again."),
    "TOO_MANY_TRYS_FAILURE_MESSAGE" : MessageLookupByLibrary.simpleMessage("Maximum number of retry attempts exceeded. Try again in a minute."),
